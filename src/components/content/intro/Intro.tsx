    ...
    <div className={buildClasses(style.container, className)} {...rest}>
      {
        /*mode === 'full'*/ true ? (
          <p>
            I'm a Front-End focused Full-Stack Engineer with 12 years of
            experience building dynamic, user-focused web applications. I
            specialize in developing responsive front-end interfaces with
            TypeScript and React, and architecting scalable back-end systems
            using Node.js, REST/GraphQL APIs, and MongoDB/SQL. My expertise
            includes designing microservices architectures, building robust
            APIs, and implementing CI/CD pipelines to support fast, reliable
            deployments.
          </p>
        ) : (
          <p>
            ...
            REST/GraphQL APIs, and MongoDB/SQL. My background includes
            performance optimization, design system implementation, and seamless
            integration across modern CI/CD pipelines.
          </p>
        )
      }
